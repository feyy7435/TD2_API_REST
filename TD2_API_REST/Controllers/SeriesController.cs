...
namespace TD2_API_REST.Controllers
{
    ...
    public class SeriesController : ControllerBase
    {
        ...
        public async Task<IActionResult> PutSerie(int id, Serie serie)
        {
            ...
            //methode Entry : permet d'accéder a l'objet Serie assé en parametre
            try
            {
                await _context.SaveChangesAsync();
                //SAveChangesAsync : aplique la MAJ
                //si reussi sa retourne le code 204 No Content sinon le code de la méthode SerieExists
            }
